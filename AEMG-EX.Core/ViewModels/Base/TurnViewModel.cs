...
namespace AEMG_EX.Core
{
    public class TurnViewModel : BaseViewModel
    {
        ...
        public TurnViewModel(TurnViewModel previous)
        {
            ...
            if (previous != null)
            {
                this.Frontline = new ObservableCollection<CharacterViewModel>(previous.Frontline.Select(c => new CharacterViewModel(c)));
                this.Backline = new ObservableCollection<CharacterViewModel>(previous.Backline.Select(c => new CharacterViewModel(c)));
                MoveCharacter();
            }
            else
                InitializeCharacterList();
        ...
        /// </summary>
        public ObservableCollection<CharacterViewModel> Frontline { get; set; }

        /// <summary>
        /// list of back line chars
        /// </summary>
        public ObservableCollection<CharacterViewModel> Backline { get; set; }
        ...
        {
            SelectCharacterCommand = new RelayCommand(p => SelectCharacter((CharacterViewModel)p));
        ...
        protected virtual void MoveCharacterRight()
        {
            ...
            if (this.Frontline.Contains(SelectedCharacter))
            {
                ...
                {
                    var newBackChar = new CharacterViewModel { CharacterIMG = SelectedCharacter.CharacterIMG };
        ...
        protected virtual void MoveCharacterLeft()
        {
            ...
            else
            {
                ...
                {
                    var newfrontChar = new CharacterViewModel { CharacterIMG = SelectedCharacter.CharacterIMG };
        ...
        {
            Frontline = new ObservableCollection<CharacterViewModel>()
            {
                new CharacterViewModel { CharacterIMG = Position.First },
                new CharacterViewModel { CharacterIMG = Position.Second },
                new CharacterViewModel { CharacterIMG = Position.Third },
                new CharacterViewModel { CharacterIMG = Position.Fourth },
            };

            Backline = new ObservableCollection<CharacterViewModel>()
            {
                new CharacterViewModel { CharacterIMG = Position.Fifth },
                new CharacterViewModel { CharacterIMG = Position.Sixth },
            };
        }
        #endregion
    }
